...
Public Sub ValidatePairedFields( _
    ...
    Set otherCell = AV_Validators.GetSiblingCell(cell, sheetName, OtherFunc)
...
Public Function Validate_GIWIncluded( _
    ...
    Set quantityCell = AV_Validators.GetSiblingCell(cell, sheetName, "GIWQuantity")
...
Public Sub Validate_HeatPairs( _
    ...
    If FuncName = "Heat_Source" Then
        Set cellA = cell
        Set cellB = AV_Validators.GetSiblingCell(cell, sheetName, "Heat_Metered")
    Else
        Set cellB = cell
        Set cellA = AV_Validators.GetSiblingCell(cell, sheetName, "Heat_Source")
    End If
