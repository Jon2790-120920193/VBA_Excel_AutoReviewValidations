...
Public Function GetAutoValidationMap(Optional wsConfig As Worksheet) As Object
    ...
    For Each r In tbl.ListRows
        ...
        If Err.Number <> 0 Then
            DebugMessage "Error reading Dev Function Names at row " & rowIndex & ": " & Err.Description, MODULE_NAME
            Err.Clear
            GoTo NextRow
        End If
        ...
        If Err.Number <> 0 Then
            DebugMessage "Error reading Drop in Column at row " & rowIndex & ": " & Err.Description, MODULE_NAME
            Err.Clear
            GoTo NextRow
        End If
        ...
        If Err.Number <> 0 Then
            DebugMessage "Error reading Prefix to message at row " & rowIndex & ": " & Err.Description, MODULE_NAME
            Err.Clear
            GoTo NextRow
        End If
        ...
        If Err.Number <> 0 Then
            DebugMessage "Error reading (FR) Prefix to message at row " & rowIndex & ": " & Err.Description, MODULE_NAME
            Err.Clear
            GoTo NextRow
        End If
        ...
        If Err.Number <> 0 Then
            DebugMessage "Error reading ReviewSheet Column Header at row " & rowIndex & ": " & Err.Description, MODULE_NAME
            Err.Clear
            GoTo NextRow
        End If
        ...
        If Err.Number <> 0 Then
            DebugMessage "Error reading AutoValidate at row " & rowIndex & ": " & Err.Description, MODULE_NAME
            Err.Clear
            GoTo NextRow
        End If
        ...
        If Err.Number <> 0 Then
            DebugMessage "Error reading RuleTableName at row " & rowIndex & ": " & Err.Description, MODULE_NAME
            Err.Clear
            GoTo NextRow
        End If
...
ErrorHandler:
    DebugMessage "CRITICAL ERROR in GetAutoValidationMap: " & Err.Number & " - " & Err.Description, MODULE_NAME
    Set GetAutoValidationMap = dict
End Function
